...
public class Wingman extends IterativeRobot {
    ...
    public void robotInit() {
        ...
        autonChooser.addObject("9 - Drive forward, fire into low goal", Integer.valueOf(9));
        autonChooser.addObject("10 - Drive forward for mobility points", Integer.valueOf(10));
